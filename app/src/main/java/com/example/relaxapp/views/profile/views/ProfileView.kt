package com.example.relaxapp.views.profile.views
...
val CustomTypography = Typography(
    headlineLarge = TextStyle(
        fontFamily = com.example.relaxapp.views.login.views.Nunito,
        fontWeight = FontWeight.Bold,
        fontSize = 30.sp,
        color = com.example.relaxapp.views.login.views.CarolinaBlue
    ),
    ...
    headlineSmall = TextStyle(
        fontFamily = com.example.relaxapp.views.login.views.Oxygen,
        fontWeight = FontWeight.Normal,
        fontSize = 14.sp,
        color = com.example.relaxapp.views.login.views.CambridgeBlue
    ),
    labelSmall = TextStyle(
        fontFamily = com.example.relaxapp.views.login.views.Oxygen,
        fontWeight = FontWeight.Normal,
        fontSize = 12.sp,
        color = com.example.relaxapp.views.login.views.AshGray
    )
)
