package com.example.relaxapp.views.doctorschedule
...
fun DoctorScheduleView(navController: NavController) {
    // Obtenemos el contexto en un ámbito composable válido
    ...
    Scaffold(
        ...
        Column(
            ...
            Box(
                ...
                OpenStreetMapView(
                    latitude = 28.6353, // Coordenadas de ejemplo
                    longitude = -106.0889
                )
            }
            ...
            Row(
                ...
                ClickableText(
                    ...
                    onClick = {
                        // Usamos el contexto para iniciar el Intent
